  ...
  return (
    ...
    >
      ...
      <div className="mx-1 flex h-full w-full flex-col items-end justify-end">
        <div className="relative mb-1 max-h-[60%] w-full overflow-hidden rounded-3xl bg-base-100 group-hover:max-h-full group-hover:shadow-xl md:bg-base-100/70 md:backdrop-blur-md md:group-hover:bg-base-100/80">
