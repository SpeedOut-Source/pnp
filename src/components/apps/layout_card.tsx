...
export default function LayoutCardApp(props: App) {
  return (
    <Link
      className="p-card h-48 cursor-pointer flex-col justify-start px-0 py-3 hover:-translate-y-1 hover:shadow-lg"
      href={`/apps/view/${props.fileName}`}
    >
      <div className="relative mx-0 h-24 w-24 overflow-hidden rounded-b-3xl px-0 text-justify">
        {props.imgUrl ? (
          <Image
            loading="lazy"
            objectFit="cover"
      ...
      <div className="mx-0 mt-1 h-fit w-fit px-2 tracking-wider">
